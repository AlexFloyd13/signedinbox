...
const LOGO_SVG = (
  <svg width="28" height="28" viewBox="0 0 128 128" fill="none">
    <defs>
      <linearGradient id="lgBg" x1="0" y1="0" x2="128" y2="128" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#6b9e7e" />
        <stop offset="100%" stopColor="#477857" />
      </linearGradient>
      <linearGradient id="lgNib" x1="64" y1="25" x2="64" y2="113" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="rgba(255,255,255,0.98)" />
        <stop offset="100%" stopColor="rgba(255,255,255,0.88)" />
      </linearGradient>
    </defs>
    <circle cx="64" cy="64" r="64" fill="url(#lgBg)" />
    <circle cx="64" cy="64" r="55" fill="none" stroke="rgba(255,255,255,0.18)" strokeWidth="1.5" />
    <path d="M64 25 L92 69 L64 113 L36 69 Z" fill="url(#lgNib)" />
    ...
    <div className="min-h-screen bg-[#f5f4ef] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-white border border-[#e5e2d8] rounded-2xl p-8 shadow-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link href="/reset-password" className="text-[12px] text-[#5a9471] hover:text-[#477857] transition-colors">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <div className="mt-6 pt-5 border-t border-[#f0ede6] text-center text-[13px] text-[#9a958e]">
          No account?{" "}
          <Link href="/signup" className="text-[#5a9471] hover:text-[#477857] font-medium transition-colors">
            Create one free
          </Link>
        </div>
      </div>
