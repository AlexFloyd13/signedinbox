        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link href="/reset-password" className="text-[12px] text-indigo-600 hover:text-indigo-800 transition-colors">
                Forgot password?
              </Link>
            </div>
            <input
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#4338ca] hover:bg-[#3730a3] disabled:opacity-50 text-white rounded-lg py-2.5 text-[14px] font-medium transition-colors mt-1"
          >
